...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", backgroundAlt: "#fff", backgroundAlt2: "rgba(255, 255, 255, 0.7)", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#F3F8FC", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#8db9df", textDisabled: "#BDC2C4", textSubtle: "#8db9df", disabled: "#E9EAEB", gradients: {
...
var ModalCloseButton = function (_a) {
    ...
    return (React__default["default"].createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog", style: { position: "absolute", right: 0, top: 0 } },
        React__default["default"].createElement(Icon$1H, { color: "#8db9df" })));
};
